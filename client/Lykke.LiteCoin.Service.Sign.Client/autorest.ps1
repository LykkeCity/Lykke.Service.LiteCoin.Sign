...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./AutorestClient -namespace Lykke.LiteCoin.Service.Sign.Client.AutorestClient
