...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./client/Lykke.Service.LiteCoin.Client/AutorestClient -namespace Lykke.Service.LiteCoin.Sign.Client.AutorestClient
